                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 border-right">
                                            <div class="description-block">
                                                <h5 class="description-header" style="color:#6892F7">{{$page['fan_count']}}</h5>
                                                <span class="description-text" style="color:#64B443">FANS</span>
                                            </div>
                                            <!-- /.description-block -->
                                        </div>
                                        <!-- /.col -->
                                        <div class="col-sm-8 border-right">
                                            <div class="description-block">
                                                <a href="{{url('/masssend/')}}/{{$page['id']}}" class="btn btn-primary"><i class="fa fa-send"> Send mass message</i> </a>
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
